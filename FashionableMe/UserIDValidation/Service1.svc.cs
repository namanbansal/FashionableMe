...
namespace UserIDValidation
{
    ...
    {
        public static string ConnectionString = @"Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\FashionableMeDB.mdf;Integrated Security=True; Database=FashionableMeDB";
